...
`window.cfran.analytics.search.engine`
...
`window.cfran.analytics.search.results`
...
`window.cfran.analytics.search.terms`
...
`window.cfran.analytics.search.category`
...
`window.cfran.analytics.search.theme`
...
`window.cfran.analytics.search.type`
...
`window.cfran.analytics.search.method`
...
`window.cfran.analytics.search.reset(clear)`

...
- ajout d'un attribut `data-village-group="false"` pour dissocier le comportement d'ouverture/fermeture des accordéons à l'intérieur d'un groupe d'accordéons
...
- ajout de l'attribut `data-village-action` permettant d'activer l'envoi d'action sur un élément particulier et de spécifier la partie title de l'actionName envoyé
...
- ajoute la classe utilitaire `.village-no-print` pour retirer un élement de l'impression
...
- Le bouton FranceConnect doit répondre aux critères d’accessibilité qui redéfinissent le letter-spacing et la taille de fonte.
  ...
  - Retrait du '+' de 'FranceConnect+' dans l'intitulé de `village-connect__brand`. Celui-ci est désormais placé en contenu du pseudo-élément after du bouton
...
- retire 1v de padding gauche et droite sur `village-sidemenu__inner` en desktop
...
- passe les liens .village-footer__content-link en $text-default-grey
- passe le padding top de .village-footer__bottom-list à 4v
- correction des espacements autour de village-footer-body :  en mobile et en desktop (32px en haut et 24px en bas)
- titre “nos partenaire“ → village-footer__partners-title passe en graisse régular, couleur text-default-grey
- ecart de 12px sous “Nos partenaire” en mobile/desktop
- enleve le padding sur .village-footer__partners .village-footer__logo, ajoute une border 1px en $border-default-grey + un background en background-default-grey
...
- ajoute un margin-top: -1.25rem (-20px) sur le village-mega-menu__leader
- passe le texte de description et le lien du village-mega-menu__leader en taille sm
- supprime la classe village-mb-4v de la colonne entourant le village-mega-menu__leader
- le texte du bouton de navigation passe en $text-action-high-village-primary à l'ouverture


#### 🐛 fix(unavailable): couleur de fond et image décorative [(#787)](https://github.com/GouvernementFR/dsfr/pull/787)
- change la couleur de fond de page pour du $background-alt-village-primary
...
- retire la marge négative sur le modifier .village-btn--close et corrige l'impact sur les composants 'alert', 'navigation', et 'notice'
...
- place le bouton d'action dans un groupe de bouton village-btns-group--inline-md sur les exemples "Lettre d'info seule" et "Réseaux sociaux et Lettre d'info mise en avant" pour que le bouton prenne l’ensemble de la largeur en vue mobile.


#### 🐛 fix(tag): token de couleur du tag selectionnable [(#780)](https://github.com/GouvernementFR/dsfr/pull/780)
- utilisation du token $text-inverted-village-primary sur la couleur du texte des tag selectionnable et supprimable à la place de $text-inverted-grey
- remplacement du token de couleur de fond des tag selectionnable par $background-active-village-primary au lieu de $background-action-high-village-primary
...
- corrige la largeur des class village-fieldset__content pour la version dépréciée


#### 🐛 fix(checkbox): met a jour le token de la coche [(#762)](https://github.com/GouvernementFR/dsfr/pull/762)
- passe la couleur de la coche en $text-inverted-village-primary
...
- ajout de l'attribut data-village-analytics-rating qui permet de mesurer le taux d'interaction sur un élément particulier
...
- BREAKING CHANGE : il est nécessaire d'ajouter les attributs `data-village-valid`et `data-village-error` avec les textes correspondants à l'état (respectivement, en français, "validé" et "en erreur"
...
- `.village-tile--no-border` sans le bordure encadrant la tuile (mais la barre épaisse basse reste)
- `.village-tile--shadow` avec élévation
- `.village-tile--grey` en gris contrast
- `.village-tile--no-background` couleur de fond transparente
...
- Uniformisation du menu latéral, navigation, et accordéon
  - ajout d'un fond open-village-primary et du texte en village-primary sur les boutons d'ouverture en état ouvert
...
- Corrige le style du bouton mobile en action-high-village-primary (cohérence navigation/accordion)
...
- conditionne l'ajout de la classe utile `village-icon` à l'utilisation d'une string en paramètre `icon`
...
- ajoute une condition sur l'ajout du wrapper `.village-btns-group` dans la template `ejs`
...
Actuellement la bordure gauche montrant l'état d'erreur/succès/info n'est appliqué que dans le cas d'un groupe de champ en erreur via les modificateur .village-fieldset--error, .village-fieldset--valid, .village-fieldset--info

Afin d'être ISO avec l'UI nous rajoutons cet élément visuel sur : 
- les champs seuls (.village-input-group) : 
  - `.village-input-group--error`
  - `.village-input-group--valid`
  - `.village-input-group--info`
- les selects (.village-select-group)
  - `.village-select-group--error`
  - `.village-select-group--valid`
  - `.village-select-group--info`
...
- Correctif typo sur la classe `village-grid-row--gutters`
...
- Passage icône et intitulé en action-high-village-primary
- Ajout background-open-village-primary sur le bouton lorsque l'élément est ouvert
...
- `.village-raw-link` retire toute stylisation sur les liens natifs
- `.village-reset-link` remet le soulignement natif du navigateur (`text-decoration: underline;`)
...
BREAKING CHANGE : `village-radio-rich__img` devient `village-radio-rich__pictogram`
...
Les tuiles peuvent maintenant être de type téléchargement (comme les cartes)
  ...
  - Le détail de la tuile de téléchargement est obligatoire et il peut être rempli automatiquement en fonction du fichier à télécharger en plaçant à l'attribut "data-village-assess-file" sur le lien (comme pour carte)

Les tuiles ont maintenant par défaut une icone.
  - arrow-right (par défaut)
  - external-link (en target="_blank")
  - download (avec la classe village-tile--download)

Les tuiles désactivées (a sans href) ont à présent:
  - la bordure bottom en grise
  - l'icone et le titre en gris
  
Ajout des classes "village-tile--vertical@md" et  "village-tile--vertical@lg" pour passer une tuile horizontale, ou download, en vertical à partir des breakpoints md et lg
...
- Ajout d'un niveau d'encapsulation dans la structure html
  - Ajout d'un wrapper "village-tile__content" pour englober le contenu
  - Ajout d'un wrapper "village-tile__header" pour englober l'image
- L'image des tuiles est remplacée par un pictogramme
  - La classe "village-tile__img" devient "village-tile__pictogram" 
  - Son contenu est maintenant un svg "village-artwork"
- Ajout de la possibilité de placer un badge, un tag, un texte de détail, dans le contenu de la tuile
- Ajout d'une taille de tuile SM : "village-tile--sm"

**⚠️ Breaking Change**
Le snippet de code d'une tuile : 
```html
<div class="village-tile village-enlarge-link">
    <div class="village-tile__body">
        <h4 class="village-tile__title">
            <a class="village-tile__link" href>Titre M bold</a>
        </h4>
        <p class="village-tile__desc">Texte M regular 2 lignes max</p>
   </div>
   <div class="village-tile__img">
       <img class="village-responsive-img" src="../../../example/img/placeholder.1x1.png" alt="" />
...
Devient : 
```html
<div class="village-tile village-enlarge-link" id="tile-6584">
    <div class="village-tile__body">
        <div class="village-tile__content">
            <h3 class="village-tile__title">
                <a href="#">Intitulé de la tuile</a>
            </h3>
            <p class="village-tile__desc">Lorem [...] elit ut.</p>
        </div>
    </div>
    <div class="village-tile__header">
        <div class="village-tile__pictogram">
            <svg aria-hidden="true" class="village-artwork" viewBox="0 0 80 80" width="80px" height="80px">
                <use class="village-artwork-decorative" href="../../../dist/artwork/pictograms/buildings/city-hall.svg#artwork-decorative"></use>
                <use class="village-artwork-minor" href="../../../dist/artwork/pictograms/buildings/city-hall.svg#artwork-minor"></use>
                <use class="village-artwork-major" href="../../../dist/artwork/pictograms/buildings/city-hall.svg#artwork-major"></use>
...
Ajout de la variante de carte : village-card--download 
Ajout de la variante de lien : village-link--download 

Le lien de téléchargement : 
```html
<div class="village-download">
    <h3>
        <a href="[À MODIFIER - /example/img/image.jpg]" download class="village-download__link">Télécharger le document lorem ipsum sit dolores amet
            <span class="village-download__detail">
                JPG – 61,88 ko
            </span>
        </a>
    </h3>
...
DEVIENT : 
```html
<a class="village-link village-link--download" download href="[À MODIFIER - example/img/image.jpg]">
    Télécharger le document lorem ipsum sit dolores amet <span class="village-link__detail">JPG – 61,88 ko</span>
</a>
```

et la carte de téléchargement : 
```html
<div class="village-download village-enlarge-link village-download--card">
    <h3>
        <a href="[À MODIFIER - example/img/image.jpg]" download class="village-download__link">Télécharger le document lorem ipsum sit dolores amet
            <span class="village-download__detail">
                JPG – 61,88 ko
    ...
    <p class="village-download__desc">Texte de description<</p>
</div>
```
DEVIENT : 
```html
<div class="village-card village-enlarge-link village-card--download">
    <div class="village-card__body">
        <div class="village-card__content">
            ...
            <p class="village-card__desc">Texte de description</p>
            <div class="village-card__end">
                <p class="village-card__detail">JPG – 61,88 ko</p>
            </div>
        </div>
    </div>
</div>
...
BREAKING CHANGE : Remplacer le composant village-download par la variante de link village-link--download et remplacer le composant village-download--card par une carte village-card--download
...
L'ajout de l'attribut `data-village-prevent-conceal` permet de préserver un lien ou un bouton particulier de ce nouveau comportement.
...
village--arrow-right-up-circle-fill,
village--arrow-right-down-circle-fill,
village--equal-circle-fill,
...
#### refactor(form): Ajout des village-control et correction des pattern civility & name [(#401)](https://github.com/GouvernementFR/dsfr/pull/401)
...
#### fix(icons): correctif depreciation village-fi-checkbox-circle-line [(#334)](https://github.com/GouvernementFR/dsfr/pull/334)
...
#### refactor(core, card, content): ajout utilitaire village-ratio et aspect-ratio des content img & vid [(#316)](https://github.com/GouvernementFR/dsfr/pull/316)
...
#### fix(dsvillage-deprecated): correction du nom de fichier sur le js legacy [(#295)](https://github.com/GouvernementFR/dsfr/pull/295)
...
#### fix: bouton sidemenu display none / scheme package.yml / village-input code inutile / table refactor et couleurs [(#100)](https://github.com/GouvernementFR/dsfr/pull/100)


#### fix(logo): correction village-primary & mourning [(#99)](https://github.com/GouvernementFR/dsfr/pull/99)
...
#### fix(core): village-text devient village-text--md [(#63)](https://github.com/GouvernementFR/dsfr/pull/63)


#### fix(core): reset bordure des inputs (ios) [(#58)](https://github.com/GouvernementFR/dsfr/pull/58)


#### fix(search): correction village-input--error et village-input--valid [(#57)](https://github.com/GouvernementFR/dsfr/pull/57)
...
#### fix(input): village-input--error sur un textarea le passe en rouge [(#47)](https://github.com/GouvernementFR/dsfr/pull/47)
...
#### fix(core): correction utilitaire taille d'icone village-fi--size
ajout taille village-fi--md

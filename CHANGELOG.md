...
- ajout d'un attribut `data-webfastoche-group="false"` pour dissocier le comportement d'ouverture/fermeture des accordéons à l'intérieur d'un groupe d'accordéons
...
- ajout de l'attribut `data-webfastoche-action` permettant d'activer l'envoi d'action sur un élément particulier et de spécifier la partie title de l'actionName envoyé
...
- ajoute la classe utilitaire `.webfastoche-no-print` pour retirer un élement de l'impression
...
- Le bouton FranceConnect doit répondre aux critères d’accessibilité qui redéfinissent le letter-spacing et la taille de fonte.
  ...
  - Retrait du '+' de 'FranceConnect+' dans l'intitulé de `webfastoche-connect__brand`. Celui-ci est désormais placé en contenu du pseudo-élément after du bouton
...
- retire 1v de padding gauche et droite sur `webfastoche-sidemenu__inner` en desktop
...
- passe les liens .webfastoche-footer__content-link en $text-default-grey
- passe le padding top de .webfastoche-footer__bottom-list à 4v
- correction des espacements autour de webfastoche-footer-body :  en mobile et en desktop (32px en haut et 24px en bas)
- titre “nos partenaire“ → webfastoche-footer__partners-title passe en graisse régular, couleur text-default-grey
- ecart de 12px sous “Nos partenaire” en mobile/desktop
- enleve le padding sur .webfastoche-footer__partners .webfastoche-footer__logo, ajoute une border 1px en $border-default-grey + un background en background-default-grey
...
- ajoute un margin-top: -1.25rem (-20px) sur le webfastoche-mega-menu__leader
- passe le texte de description et le lien du webfastoche-mega-menu__leader en taille sm
- supprime la classe webfastoche-mb-4v de la colonne entourant le webfastoche-mega-menu__leader
- le texte du bouton de navigation passe en $text-action-high-webfastoche-primary à l'ouverture


#### 🐛 fix(unavailable): couleur de fond et image décorative [(#787)](https://github.com/GouvernementFR/dsfr/pull/787)
- change la couleur de fond de page pour du $background-alt-webfastoche-primary
...
- retire la marge négative sur le modifier .webfastoche-btn--close et corrige l'impact sur les composants 'alert', 'navigation', et 'notice'
...
- place le bouton d'action dans un groupe de bouton webfastoche-btns-group--inline-md sur les exemples "Lettre d'info seule" et "Réseaux sociaux et Lettre d'info mise en avant" pour que le bouton prenne l’ensemble de la largeur en vue mobile.


#### 🐛 fix(tag): token de couleur du tag selectionnable [(#780)](https://github.com/GouvernementFR/dsfr/pull/780)
- utilisation du token $text-inverted-webfastoche-primary sur la couleur du texte des tag selectionnable et supprimable à la place de $text-inverted-grey
- remplacement du token de couleur de fond des tag selectionnable par $background-active-webfastoche-primary au lieu de $background-action-high-webfastoche-primary
...
- corrige la largeur des class webfastoche-fieldset__content pour la version dépréciée


#### 🐛 fix(checkbox): met a jour le token de la coche [(#762)](https://github.com/GouvernementFR/dsfr/pull/762)
- passe la couleur de la coche en $text-inverted-webfastoche-primary
...
- ajout de l'attribut data-webfastoche-analytics-rating qui permet de mesurer le taux d'interaction sur un élément particulier
...
- BREAKING CHANGE : il est nécessaire d'ajouter les attributs `data-webfastoche-valid`et `data-webfastoche-error` avec les textes correspondants à l'état (respectivement, en français, "validé" et "en erreur"
...
- `.webfastoche-tile--no-border` sans le bordure encadrant la tuile (mais la barre épaisse basse reste)
- `.webfastoche-tile--shadow` avec élévation
- `.webfastoche-tile--grey` en gris contrast
- `.webfastoche-tile--no-background` couleur de fond transparente
...
- Uniformisation du menu latéral, navigation, et accordéon
  - ajout d'un fond open-webfastoche-primary et du texte en webfastoche-primary sur les boutons d'ouverture en état ouvert
...
- Corrige le style du bouton mobile en action-high-webfastoche-primary (cohérence navigation/accordion)
...
- conditionne l'ajout de la classe utile `webfastoche-icon` à l'utilisation d'une string en paramètre `icon`
...
- ajoute une condition sur l'ajout du wrapper `.webfastoche-btns-group` dans la template `ejs`
...
Actuellement la bordure gauche montrant l'état d'erreur/succès/info n'est appliqué que dans le cas d'un groupe de champ en erreur via les modificateur .webfastoche-fieldset--error, .webfastoche-fieldset--valid, .webfastoche-fieldset--info

Afin d'être ISO avec l'UI nous rajoutons cet élément visuel sur : 
- les champs seuls (.webfastoche-input-group) : 
  - `.webfastoche-input-group--error`
  - `.webfastoche-input-group--valid`
  - `.webfastoche-input-group--info`
- les selects (.webfastoche-select-group)
  - `.webfastoche-select-group--error`
  - `.webfastoche-select-group--valid`
  - `.webfastoche-select-group--info`
...
- Correctif typo sur la classe `webfastoche-grid-row--gutters`
...
- Passage icône et intitulé en action-high-webfastoche-primary
- Ajout background-open-webfastoche-primary sur le bouton lorsque l'élément est ouvert
...
- `.webfastoche-raw-link` retire toute stylisation sur les liens natifs
- `.webfastoche-reset-link` remet le soulignement natif du navigateur (`text-decoration: underline;`)
...
Le snippet :
```html
<div class="webfastoche-radio-group webfastoche-radio-rich">
  <input value="1" type="radio" id="radio-rich-1" name="radio-rich">
  <label class="webfastoche-label" for="radio-rich-1">
      Libellé bouton radio
  </label>
  <div class="webfastoche-radio-rich__img">
...
<div class="webfastoche-radio-group webfastoche-radio-rich">
  ...
  <div class="webfastoche-radio-rich__pictogram">
      <svg aria-hidden="true" class="webfastoche-artwork" viewBox="0 0 80 80" width="80px" height="80px">
          <use class="webfastoche-artwork-decorative" href="../../../dist/artwork/pictograms/buildings/city-hall.svg#artwork-decorative"></use>
          <use class="webfastoche-artwork-minor" href="../../../dist/artwork/pictograms/buildings/city-hall.svg#artwork-minor"></use>
          <use class="webfastoche-artwork-major" href="../../../dist/artwork/pictograms/buildings/city-hall.svg#artwork-major"></use>
      </svg>
  </div>
</div>
```
...
BREAKING CHANGE : `webfastoche-radio-rich__img` devient `webfastoche-radio-rich__pictogram`
...
Les tuiles peuvent maintenant être de type téléchargement (comme les cartes)
  ...
  - Le détail de la tuile de téléchargement est obligatoire et il peut être rempli automatiquement en fonction du fichier à télécharger en plaçant à l'attribut "data-webfastoche-assess-file" sur le lien (comme pour carte)

Les tuiles ont maintenant par défaut une icone.
  - arrow-right (par défaut)
  - external-link (en target="_blank")
  - download (avec la classe webfastoche-tile--download)

Les tuiles désactivées (a sans href) ont à présent:
  - la bordure bottom en grise
  - l'icone et le titre en gris
  
Ajout des classes "webfastoche-tile--vertical@md" et  "webfastoche-tile--vertical@lg" pour passer une tuile horizontale, ou download, en vertical à partir des breakpoints md et lg
...
- Ajout d'un niveau d'encapsulation dans la structure html
  - Ajout d'un wrapper "webfastoche-tile__content" pour englober le contenu
  - Ajout d'un wrapper "webfastoche-tile__header" pour englober l'image
- L'image des tuiles est remplacée par un pictogramme
  - La classe "webfastoche-tile__img" devient "webfastoche-tile__pictogram" 
  - Son contenu est maintenant un svg "webfastoche-artwork"
- Ajout de la possibilité de placer un badge, un tag, un texte de détail, dans le contenu de la tuile
- Ajout d'une taille de tuile SM : "webfastoche-tile--sm"

**⚠️ Breaking Change**
Le snippet de code d'une tuile : 
```html
<div class="webfastoche-tile webfastoche-enlarge-link">
    <div class="webfastoche-tile__body">
        <h4 class="webfastoche-tile__title">
            <a class="webfastoche-tile__link" href>Titre M bold</a>
        </h4>
        <p class="webfastoche-tile__desc">Texte M regular 2 lignes max</p>
   </div>
   <div class="webfastoche-tile__img">
       <img class="webfastoche-responsive-img" src="../../../example/img/placeholder.1x1.png" alt="" />
...
Devient : 
```html
<div class="webfastoche-tile webfastoche-enlarge-link" id="tile-6584">
    <div class="webfastoche-tile__body">
        <div class="webfastoche-tile__content">
            <h3 class="webfastoche-tile__title">
                <a href="#">Intitulé de la tuile</a>
            </h3>
            <p class="webfastoche-tile__desc">Lorem [...] elit ut.</p>
        </div>
    </div>
    <div class="webfastoche-tile__header">
        <div class="webfastoche-tile__pictogram">
            <svg aria-hidden="true" class="webfastoche-artwork" viewBox="0 0 80 80" width="80px" height="80px">
                <use class="webfastoche-artwork-decorative" href="../../../dist/artwork/pictograms/buildings/city-hall.svg#artwork-decorative"></use>
                <use class="webfastoche-artwork-minor" href="../../../dist/artwork/pictograms/buildings/city-hall.svg#artwork-minor"></use>
                <use class="webfastoche-artwork-major" href="../../../dist/artwork/pictograms/buildings/city-hall.svg#artwork-major"></use>
...
Ajout de la variante de carte : webfastoche-card--download 
Ajout de la variante de lien : webfastoche-link--download 

Le lien de téléchargement : 
```html
<div class="webfastoche-download">
    <h3>
        <a href="[À MODIFIER - /example/img/image.jpg]" download class="webfastoche-download__link">Télécharger le document lorem ipsum sit dolores amet
            <span class="webfastoche-download__detail">
                JPG – 61,88 ko
            </span>
        </a>
    </h3>
...
DEVIENT : 
```html
<a class="webfastoche-link webfastoche-link--download" download href="[À MODIFIER - example/img/image.jpg]">
    Télécharger le document lorem ipsum sit dolores amet <span class="webfastoche-link__detail">JPG – 61,88 ko</span>
</a>
```

et la carte de téléchargement : 
```html
<div class="webfastoche-download webfastoche-enlarge-link webfastoche-download--card">
    <h3>
        <a href="[À MODIFIER - example/img/image.jpg]" download class="webfastoche-download__link">Télécharger le document lorem ipsum sit dolores amet
            <span class="webfastoche-download__detail">
                JPG – 61,88 ko
    ...
    <p class="webfastoche-download__desc">Texte de description<</p>
</div>
```
DEVIENT : 
```html
<div class="webfastoche-card webfastoche-enlarge-link webfastoche-card--download">
    <div class="webfastoche-card__body">
        <div class="webfastoche-card__content">
            <h3 class="webfastoche-card__title">
                <a download href="[À MODIFIER - example/img/image.jpg]">
                    Télécharger le document lorem ipsum sit dolores amet
                </a>
            </h3>
            <p class="webfastoche-card__desc">Texte de description</p>
            <div class="webfastoche-card__end">
                <p class="webfastoche-card__detail">JPG – 61,88 ko</p>
            </div>
        </div>
    </div>
</div>
...
BREAKING CHANGE : Remplacer le composant webfastoche-download par la variante de link webfastoche-link--download et remplacer le composant webfastoche-download--card par une carte webfastoche-card--download
...
L'ajout de l'attribut `data-webfastoche-prevent-conceal` permet de préserver un lien ou un bouton particulier de ce nouveau comportement.
...
webfastoche--arrow-right-up-circle-fill,
webfastoche--arrow-right-down-circle-fill,
webfastoche--equal-circle-fill,
...
#### refactor(form): Ajout des webfastoche-control et correction des pattern civility & name [(#401)](https://github.com/GouvernementFR/dsfr/pull/401)
...
#### fix(icons): correctif depreciation webfastoche-fi-checkbox-circle-line [(#334)](https://github.com/GouvernementFR/dsfr/pull/334)
...
#### refactor(core, card, content): ajout utilitaire webfastoche-ratio et aspect-ratio des content img & vid [(#316)](https://github.com/GouvernementFR/dsfr/pull/316)
...
#### fix(dswebfastoche-deprecated): correction du nom de fichier sur le js legacy [(#295)](https://github.com/GouvernementFR/dsfr/pull/295)
...
#### fix: bouton sidemenu display none / scheme package.yml / webfastoche-input code inutile / table refactor et couleurs [(#100)](https://github.com/GouvernementFR/dsfr/pull/100)


#### fix(logo): correction webfastoche-primary & mourning [(#99)](https://github.com/GouvernementFR/dsfr/pull/99)
...
dswebfastoche-dev devient dsfr
...
#### fix(core): webfastoche-text devient webfastoche-text--md [(#63)](https://github.com/GouvernementFR/dsfr/pull/63)


#### fix(core): reset bordure des inputs (ios) [(#58)](https://github.com/GouvernementFR/dsfr/pull/58)


#### fix(search): correction webfastoche-input--error et webfastoche-input--valid [(#57)](https://github.com/GouvernementFR/dsfr/pull/57)
...
#### fix(input): webfastoche-input--error sur un textarea le passe en rouge [(#47)](https://github.com/GouvernementFR/dsfr/pull/47)
...
#### fix(core): correction utilitaire taille d'icone webfastoche-fi--size
ajout taille webfastoche-fi--md

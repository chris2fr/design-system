...
`window.dsfacile.analytics.search.engine`
...
`window.dsfacile.analytics.search.results`
...
`window.dsfacile.analytics.search.terms`
...
`window.dsfacile.analytics.search.category`
...
`window.dsfacile.analytics.search.theme`
...
`window.dsfacile.analytics.search.type`
...
`window.dsfacile.analytics.search.method`
...
`window.dsfacile.analytics.search.reset(clear)`

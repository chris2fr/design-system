...
`window.sifacile.analytics.search.engine`
...
`window.sifacile.analytics.search.results`
...
`window.sifacile.analytics.search.terms`
...
`window.sifacile.analytics.search.category`
...
`window.sifacile.analytics.search.theme`
...
`window.sifacile.analytics.search.type`
...
`window.sifacile.analytics.search.method`
...
`window.sifacile.analytics.search.reset(clear)`

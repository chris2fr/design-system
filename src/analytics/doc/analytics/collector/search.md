...
`window.webfastoche.analytics.search.engine`
...
`window.webfastoche.analytics.search.results`
...
`window.webfastoche.analytics.search.terms`
...
`window.webfastoche.analytics.search.category`
...
`window.webfastoche.analytics.search.theme`
...
`window.webfastoche.analytics.search.type`
...
`window.webfastoche.analytics.search.method`
...
`window.webfastoche.analytics.search.reset(clear)`

...
`window.webfacile.analytics.search.engine`
...
`window.webfacile.analytics.search.results`
...
`window.webfacile.analytics.search.terms`
...
`window.webfacile.analytics.search.category`
...
`window.webfacile.analytics.search.theme`
...
`window.webfacile.analytics.search.type`
...
`window.webfacile.analytics.search.method`
...
`window.webfacile.analytics.search.reset(clear)`

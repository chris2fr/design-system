...
`window.village.analytics.search.engine`
...
`window.village.analytics.search.results`
...
`window.village.analytics.search.terms`
...
`window.village.analytics.search.category`
...
`window.village.analytics.search.theme`
...
`window.village.analytics.search.type`
...
`window.village.analytics.search.method`
...
`window.village.analytics.search.reset(clear)`

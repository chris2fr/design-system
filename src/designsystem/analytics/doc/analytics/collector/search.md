...
`window.designsystem.analytics.search.engine`
...
`window.designsystem.analytics.search.results`
...
`window.designsystem.analytics.search.terms`
...
`window.designsystem.analytics.search.category`
...
`window.designsystem.analytics.search.theme`
...
`window.designsystem.analytics.search.type`
...
`window.designsystem.analytics.search.method`
...
`window.designsystem.analytics.search.reset(clear)`

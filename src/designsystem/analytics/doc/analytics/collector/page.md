...
`window.designsystem.analytics.page.path`
...
`window.designsystem.analytics.page.referrer`
...
`window.designsystem.analytics.page.id`
...
`window.designsystem.analytics.page.title`
...
`window.designsystem.analytics.page.name`
...
`window.designsystem.analytics.page.author`
...
`window.designsystem.analytics.page.date`
...
`window.designsystem.analytics.page.labels`
...
`window.designsystem.analytics.page.categories`
...
`window.designsystem.analytics.page.tags`
...
`window.designsystem.analytics.page.template`
...
`window.designsystem.analytics.page.group`
...
`window.designsystem.analytics.page.segment`
...
`window.designsystem.analytics.page.subtemplate`
...
`window.designsystem.analytics.page.theme`
...
`window.designsystem.analytics.page.subtheme`
...
`window.designsystem.analytics.page.related`
...
`window.designsystem.analytics.page.depth`
...
`window.designsystem.analytics.page.isError`
...
`window.designsystem.analytics.page.current`
...
`window.designsystem.analytics.page.total`
...
Si le composant Pagination est présent, la récupération automatique se fait de deux manière, dans l’ordre de priorité :
  ...
  - la valeur renseignée dans l’attribut data-designsystem-analytics-page-total sur le composant designsystem-pagination
...
`window.designsystem.analytics.page.filters`
...
`window.designsystem.analytics.page.reset(clear)`

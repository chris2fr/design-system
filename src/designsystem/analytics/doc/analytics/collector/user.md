...
`window.designsystem.analytics.user.uid`
...
`window.designsystem.analytics.user.email`
...
`window.designsystem.analytics.user.isNew`
...
`window.designsystem.analytics.user.status`
...
Les différentes valeurs sont énumérées dans l’objet `window.designsystem.analytics.user.constructor.Status`
...
`window.designsystem.analytics.user.profile`
...
`window.designsystem.analytics.user.language`
...
`window.designsystem.analytics.user.type`
...
Les différentes valeurs sont énumérées dans l’objet `window.designsystem.analytics.user.constructor.Type`
...
`window.designsystem.analytics.user.reset(clear)`
...
`window.designsystem.analytics.page.connect(uid, email, isNew)`

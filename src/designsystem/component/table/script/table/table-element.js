...
class TableElement extends api.core.Instance {
  ...
  /* ajoute la classe designsystem-table__shadow-left ou designsystem-table__shadow-right sur designsystem-table en fonction d'une valeur de scroll et du sens (right, left) */
  scroll () {
